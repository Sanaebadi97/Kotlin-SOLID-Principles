...
import info.sanaebadi.kotlinSolidPrinciples.academy.DIP.before.data.DataLayer
import info.sanaebadi.kotlinSolidPrinciples.academy.DIP.before.data.IDataLayer
...
class BusinessLayer {
    ...
    private var dataLayer: IDataLayer? = null

    fun BusinessLayer(dataLayer: IDataLayer?) {
